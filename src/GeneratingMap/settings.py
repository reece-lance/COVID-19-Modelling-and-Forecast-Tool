...
# Maps output destination

MAPS_DESTINATION = 'maps'
MAPS_DESTINATION_PROJECT = '..\\covid-mft-desktop-jv\\src\\main\\Resources\\ColourColorMap'

MAP_FILE_NAME_FORMAT = '{description}_map.owo'

DIAGNOSTICS = False
DIAGNOSTIC_LABELS = True

scale = 4
EXPORT_RESOLUTION = (1920*scale, 1080*scale)
