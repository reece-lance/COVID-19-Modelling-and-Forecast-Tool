...
import csee.ce291_team02.Data.LmaoNinjaApiClient.MugBigDecimalAdapter;
...
public class JSON {
    ...
    private MugBigDecimalAdapter mugBigDecimalAdapter = new MugBigDecimalAdapter();
    ...
    public JSON() {
        gson = createGson()
            ...
            .registerTypeAdapter(BigDecimal.class, mugBigDecimalAdapter)
            .create();
    }
